...
@section('content')
<div class="container mx-auto mt-10 px-6 max-w-4xl">
    <h1 class="text-4xl font-bold text-white mb-6 text-center sm:text-left">Bem-vindo à Home</h1>

    <div class="space-y-4 text-gray-300 text-center sm:text-left">
        <p class="text-lg leading-relaxed">
            ...
            Aproveite para explorar cada funcionalidade e não tenha medo de experimentar – a criatividade é o limite! Estamos aqui para ajudar em cada etapa do seu desenvolvimento.
        </p>
    </div>

    <!-- Exemplo de Cartão -->
    <div class="mt-10 bg-gray-800 p-6 rounded-lg shadow-lg text-white text-center sm:text-left">
        ...
        <ul class="list-disc list-inside text-gray-200 space-y-2 text-left sm:text-center">
    ...
    <!-- Cartão de Destaque -->
    <div class="mt-8 bg-blue-800 p-6 rounded-lg text-white shadow-lg text-center sm:text-left">
